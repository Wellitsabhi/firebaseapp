  ...
  try {
    useEffect(() => {
      ...
      const unsubscribe = onValue(sensorsRef, (snapshot) => {
        ...
        // Cleanup function to unsubscribe when component unmounts or when dependency changes
    return () => {
      unsubscribe();
    };
      })
    ...
    <>
      ...
      <div id="home" className=" flex flex-row flex-wrap justify-center ml-4 ">
        <div className="card w-96 bg-base-100 shadow-xl m-auto mt-10 mb-10 pt-4">
          <div className="radial-progress m-auto" style={{ "--value": `${sensors.celsius}`, "--size": "12rem", "--thickness": "2rem" }} role="progressbar">{sensors.celsius}</div>
        ...
        {/* sensor-temp-F */}
        <div className="card  w-96 bg-base-100 shadow-xl m-auto mt-10 mb-10 pt-4">
          <div className="radial-progress  m-auto " style={{ "--value": `${sensors.fahrenheit}` , "--size": "12rem", "--thickness": "2rem" }} role="progressbar">{sensors.fahrenheit}</div>
          <div className="card-body items-center text-center">
        ...
        {/* sensor-tds */}
        <div className="card  w-96 bg-base-100 shadow-xl m-auto mt-10 mb-10 pt-4">
          <div className="radial-progress m-auto" style={{ "--value": `${sensors.tds}`, "--size": "12rem", "--thickness": "2rem" }} role="progressbar">{sensors.tds}</div>
          <div className="card-body items-center text-center">
        ...
        {/* sensor-EC */}
        <div className="card  w-96 bg-base-100 shadow-xl m-auto mt-10 mb-10 pt-4">
          <div className="radial-progress m-auto" style={{ "--value": `${sensors.ec}`, "--size": "12rem", "--thickness": "2rem" }} role="progressbar">{sensors.ec}</div>
          <div className="card-body items-center text-center">
            <h2 className="card-title">Electrical Conductivity</h2>
          </div>
        </div>
      </div>
